...
//Home Page
const greeting = {
  title: "Muhammad Shahzaib Khan",
  logo_name: "Shahzaib Khan",
  nickname: "Shah",
  subTitle:
    "An aspiring developer who loves to take on new projects that challenges his analytical and technological capacities.",
  resumeLink:
    "https://drive.google.com/file/d/1Tg6N3t7XNbFyc1s3yVjQmaRHJOXmcfsN/view?usp=drivesdk",
  portfolio_repository: "https://github.com/shahkhan99",
};

const socialMediaLinks = [
  {
    name: "Github",
    link: "https://github.com/shahkhan99",
    fontAwesomeIcon: "fa-github", // Reference https://fontawesome.com/icons/github?style=brands
    backgroundColor: "#181717", // Reference https://simpleicons.org/?q=github
  },
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/shahzaib-k-b7761011b",
  ...
  // // },
  {
    name: "Gmail",
    link:
      "https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=hafizshahzaib2012@gmail.com&subject=MISSED%20CALL%20EZTRADER&body=Hello",
  ...
  */
  {
    name: "Facebook",
    link: "https://www.facebook.com/hafiz.shahzaib2",
    fontAwesomeIcon: "fa-facebook-f", // Reference https://fontawesome.com/icons/facebook-f?style=brands
    backgroundColor: "#1877F2", // Reference https://simpleicons.org/?q=facebook
  },
  {
    name: "Instagram",
    link: "https://www.instagram.com/m_shahzaib_khan79",
  ...
  data: [
    ...
    },
    {
      ...
      softwareSkills: [
        ...
        {
          skillName: "xCode",
          fontAwesomeClassname: "simple-icons:fa-app-store-ios",
          style: {
            color: "#3DDC84",
          },
        },
...
const degrees = {
  degrees: [
    {
      title: "PAF-Karachi Institute of Economics and Technology",
      subtitle: "BS in Computer Science",
      logo_path: "kiet_logo.jpeg",
      alt_name: "IIITDM Kurnool",
      duration: "Augest 2016 - December 2020",
      cgpa: "",
      descriptions: [
        "⚡ I have studied basic software engineering subjects like DS, Algorithms, OOP, DBMS, OS, CA, AI etc.",
        "⚡ I got best course project awards in CA and DLD .",
        "⚡ My FYP was selected in top 25 projects out of 100 projects.",
        "⚡ Elected as the team leader in all the group projects.",
      ],
      website_link: "http://www.pafkiet.edu.pk",
    },
  ],
};
...
const experience = {
  ...
  description:
    "I have more than 1.5 years of experience in fullstack development using react, node and firebase",
      ...
      experiences: [
        {
          ...
          company: "Work Hall",
          company_url: "https://workhall.co/",
          logo_path: "WHlogo.png",
          duration: "September 2020 - PRESENT",
          location: "Karachi, Pakistan",
          description:
            "I am working on their website and mobile app by using modern technologies like react, node and firebase.",
          color: "#0879bf",
        },
        {
          title: "Fullstack Developer",
          company: "The TechGlance",
          company_url: "https://",
          logo_path: "techglance.png",
          duration: "Augest 2020 - September 2020",
          location: "Karachi, Pakistan",
          description:
            "I was working on the different projects like lottery app, eCommere app, academy web and etc.",
          color: "#0879bf",
        },
      ...
      experiences: [
        {
          ...
          company: "TBD Solutions",
          company_url: "https://",
          logo_path: "tbd.jpg",
          duration: "Feb 2020 - June 2020",
          location: "Karachi, Pakistan",
          description:
            "Worked here as an frontend developer by using simple html, css and javascript, also start working on react native.",
          color: "#ee3c26",
        },
      ],
    },
      ...
      experiences: [
        {
          ...
          company: "Facial Recognition Door Lock",
          company_url: "",
          logo_path: "google_logo.png",
          duration: "September 2019 - June 2020",
          location: "PAF-KIET",
          description:
            "This project deals with providing the security to the users, using IOT for door systems which can be integrated in houses/banks or any other place. Raspberry pi is also used in this to provide video view and control the lock of the door, this module also uses Machine Learning techniques to detect users face and match from the faces that are registered in database by facial recognition techniques.",
          color: "#4285F4",
        },
        /*
        {
          ...
          location: "Hyderabad, Telangana",
          description:
            "This project deals with providing the security to the users, using IOT for 
door systems which can be integrated in houses/banks or any other place. 
Raspberry pi is also used in this to provide video view and control the lock 
of the door, this module also uses Machine Learning techniques to detect 
users face and match from the faces that are registered in database by 
...
const contactPageData = {
  contactSection: {
    ...
    description:
      "I am available on almost every social media. You can message me, I will reply within 24 hours. I can help you with Basic Programming, ML, AI, React Native, Cloud and Opensource Development.",
  },
  blogSection: {
    title: "Blogs",
    subtitle:
